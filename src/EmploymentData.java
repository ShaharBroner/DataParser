public class EmploymentData {
    ...
    public EmploymentData(int totalLaborForce, int employedLaborForce, int unemployedLaborForce, int unemployedPercent, String countyName, String stateName, int fips) {
